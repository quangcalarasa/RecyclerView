...
public class ProductAdapter extends RecyclerView.Adapter {
    ...
    private IOnClickItem iOnClickItemLisener;

    public ProductAdapter(Activity activity, List<Product> listProduct,IOnClickItem iOnClickItemLisener) {
        this.activity = activity;
        this.listProduct = listProduct;
        this.iOnClickItemLisener = iOnClickItemLisener;
    }
    @Override
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        vh.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                iOnClickItemLisener.onClickItem(position);
            }
        });
    }
